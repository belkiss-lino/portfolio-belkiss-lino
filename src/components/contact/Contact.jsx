      ...
      <div className="container contact__container">
          <div className="contact__options">
            <article className="contact__option">
              ...
              <h4>Email</h4>
              <h5>belkiss.lino@gmail.com</h5>
              <a href='mailto:belkiss.lino@gmail.com'>Mande uma mensagem</a>
            </article>

            <article className="contact__option">
              <BsWhatsapp className='contact__option-icon' />
              <h4>WhatsApp</h4>
              <h5>+55 (31) 99150-1250</h5>
              <a href='https://api.whatsapp.com/send?phone=5531991501250'>Envie uma mensagem</a>
            </article>
          </div>
